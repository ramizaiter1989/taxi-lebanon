...
const styles = StyleSheet.create({
  ...
  // Loading / Error
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FFF9FB' },
  loadingText: { fontSize: 16, color: '#A56B7A', fontWeight: '600', marginTop: 12 },
  errorText: { fontSize: 16, color: '#E57373', fontWeight: '600', marginTop: 16, textAlign: 'center', paddingHorizontal: 32 },
  errorButton: { marginTop: 20, backgroundColor: '#EFA7B7', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 25, elevation: 3 },
  ...
  headerAvatarText: { fontSize: 18, fontWeight: '700', color: '#A56B7A' },
  headerTextContainer: { flex: 1 },
  headerTitle: { fontSize: 18, fontWeight: '700', color: '#6D2941', letterSpacing: 0.4 },
  headerSubtitleRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  statusDot: { width: 8, height: 8, borderRadius: 4, marginRight: 6 },
  headerSubtitle: { fontSize: 12, color: '#8C5A67', fontWeight: '500' },
  moreButton: { padding: 4 },

  // Messages
  messagesContainer: { flex: 1, backgroundColor: '#FFF9FB' },
  ...
  avatarText: { color: '#6D2941', fontWeight: '700', fontSize: 15 },
  ...
  failedMessage: { backgroundColor: '#FFD6D6', borderWidth: 1, borderColor: '#FF9A9A' },
  senderName: { fontSize: 12, color: '#A56B7A', fontWeight: '700', marginBottom: 4 },
  messageText: { fontSize: 15, lineHeight: 22 },
  myMessageText: { color: '#FFF' },
  theirMessageText: { color: '#5A3E47' },
  ...
  myTimestamp: { color: 'rgba(255,255,255,0.85)' },
  theirTimestamp: { color: '#B57B89' },
  ...
  emptyText: { fontSize: 20, color: '#A56B7A', fontWeight: '700', marginBottom: 8 },
  emptySubtext: { fontSize: 15, color: '#C08FA1', textAlign: 'center', lineHeight: 22 },
  ...
  sendButton: { width: 42, height: 42, borderRadius: 21, overflow: 'hidden', marginLeft: 4 },
  sendButtonGradient: {
    width: '100%',
    height: '100%',
    justifyContent: 'center',
